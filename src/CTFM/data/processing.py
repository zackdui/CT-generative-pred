    ...
    for index, row in df_single_patient.iterrows():
        ...
        for exam_id in row["exam_id"][1:]:
            ...
            if not os.path.exists(fwd_tmp):
                ...
                _log_skip(bad_exam_json, exam_id, full_data_exam_row['pid'], error="Missing temporary forward transform file")
                continue
            ...
            try:
                ...
                _log_skip(bad_exam_json, exam_id, full_data_exam_row['pid'], error="Failed to move temporary forward transform file")
                continue
